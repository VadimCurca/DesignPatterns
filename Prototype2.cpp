...
class ConcretePrototype1 : public Prototype {
  ...
  public:
     ...
     * replica. so, the client (who call the clone method) has the
     * responsability to free that memory. I you have smart pointer knowledge
...
class PrototypeFactory {
  ...
  public:
    ...
    /**
     * Be carefull of free all memory allocated. Again, if you have smart
     * pointers knowelege will be better to use it here.
     */
